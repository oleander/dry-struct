...
module Dry
  class Struct
    ...
    # Calls on the module gets dispached to {Constructor#sum}
    # which is responsible for constructing a sum type consisting
    # of constants within the module. The module can be contain
    # other constants as only the compatible ones are selected
    #
